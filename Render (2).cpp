...
void DublicateTriangle(double* a, double* b, double* c, int height) {
	glNormal3d(0, 0, 1);
	double a1[] = { a[0], a[1], height };
	double b1[] = { b[0], b[1], height };
	double c1[] = { c[0], c[1], height };
	glVertex3dv(a1);
	glVertex3dv(b1);
	glVertex3dv(c1);
	glNormal3d(0, 0, -1);
...
void Render(OpenGL *ogl)
{
	...
	DublicateTriangle(A, B, H, 5);

	glVertex3dv(H);
	glVertex3dv(B);
	glVertex3dv(G);

	DublicateTriangle(H, B, G, 5);

	glVertex3dv(B);
	glVertex3dv(G);
	glVertex3dv(E);

	DublicateTriangle(E, B, G, 5);

	glVertex3dv(G);
	glVertex3dv(E);
	glVertex3dv(F);

	DublicateTriangle(G, F, E, 5);

	glVertex3dv(C);
	glVertex3dv(E);
	glVertex3dv(B);

	DublicateTriangle(C, B, E, 5);

	glVertex3dv(C);
	glVertex3dv(D);
	glVertex3dv(E);

	DublicateTriangle(C, D, E, 5);
	glEnd();
	glBegin(GL_QUADS);
	glColor3d(0, 0.5, 0);

	glNormal3dv(Norm(A, B, B1));
