...
void Render(OpenGL *ogl)
{
	...
	//glVertex3dv(up[2]);
		...
		//Конец призмы и начало рисования квадратика станкина


		double A[3] = { 1, -2, 1.005 };
		double B[3] = { -3, -6, 1.005 };
		double C[3] = { -5, -2, 1.005 };
		double D[3] = { 0, 0, 1.005 };
		glBindTexture(GL_TEXTURE_2D, texId);
   ...
   //Сообщение вверху экрана
	...
	ss << "J - переключить задание" << std::endl;
